...
Revision ID: cf20e97b194b
Revises: 
Create Date: 2026-05-13 11:05:31.393882
...
def upgrade():
    ...
    sa.Column('type', sa.Enum('University', 'Bootcamp', name='institution_type'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('challenge_id', sa.Integer(), nullable=False),
    sa.Column('language', sa.Enum('python', 'javascript', name='submission_language'), nullable=False),
